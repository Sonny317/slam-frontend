                ...
                <>
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="bg-green-100 p-4 rounded-lg">
                      <p className="text-2xl font-bold text-green-600">{eventStats.attendingCount}</p>
                      <p className="text-sm text-green-700">Attending</p>
                    </div>
                    <div className="bg-blue-100 p-4 rounded-lg">
                      <p className="text-2xl font-bold text-blue-600">{eventStats.afterPartyCount}</p>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-2xl w-full max-w-4xl max-h-[80vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold">Attendee List - {selectedEvent?.title}</h2>
                <button 
